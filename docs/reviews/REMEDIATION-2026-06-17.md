...
## P1-9 跨前端共享会话逻辑（CLI / AppKit） [DONE]
...
| **建议方案** | 1. README 增加 AppKit Application 章节。<br>2. ARCHITECTURE.md 补充 `ForgeLoopApp` 第四层、修正 ForgeLoopTUI 外部包路径。<br>3. 从 AGENTS.md、RELEASE-CHECKLIST.md、Claude.md、CONTRIBUTING.md、`COLLABORATION.md` 及历史日志中移除对已删除的 Step 看板文件的引用；`docs/reviews/REVIEW-LOG.md` 已存在并继续维护。 |
